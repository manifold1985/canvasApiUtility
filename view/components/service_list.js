export default function(mQL, populate = false) {
  ...
  if (mQL.matches) {
    ...
    $('#service-list')
      .text('The mobile device version is under construction. Please use a desktop device.')
      .css('font-size', '16pt')
      .append('<span class="glyphicon glyphicon-wrench" style="display: block; font-size: 150px; padding-top: 50px; text-align: center" aria-hidden="true"></span>');
  }
};
